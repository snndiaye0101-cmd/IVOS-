...
export const ADMIN_TABS_CONFIG: Array<{ id: AdminTab; label: string; iconName: AppModule; requiresSuperAdmin?: boolean }> = [
...
// STYLING DEFINITIONS
// ──────────────────────────────────────────────────────────────
export const SEVERITY_STYLES: Record<AuditEntry['severity'], { bg: string; text: string; label: string }> = {
