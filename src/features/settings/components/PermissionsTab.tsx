  ...
  return (
    <div className="space-y-6">
      ...
      <div className="ivos-card">
        <h3 className="mb-4 text-sm font-bold text-gray-900">Sélectionner un Utilisateur</h3>
        ...
        <div className="ivos-card">
          <div className="mb-4 flex items-center justify-between">
            <div>
              ...
              <p className="mt-1 text-xs text-gray-500">{selectedUser.fullName}</p>
            </div>
          ...
          {/* Permissions Table */}
          <div className="-mx-6 overflow-x-auto rounded-lg border border-gray-200 md:mx-0">
            <table className="w-full text-sm">
              <thead className="border-b border-gray-200 bg-gray-50">
                <tr>
                  <th className="px-4 py-3 text-left font-semibold text-gray-700 md:min-w-[150px]">
                    Module
                  </th>
              ...
              <tbody>
                {MODULES.map((module) => (
                  ...
                  >
                    <td className="px-4 py-3 font-semibold text-gray-900 md:min-w-[150px]">
                      ...
                      return (
                        <td key={level} className="px-4 py-3 text-center">
                          <button
                            ...
                            className={`mx-auto flex h-6 w-6 items-center justify-center rounded-lg transition-all ${
                              isGranted
          ...
          <div className="mt-6 flex flex-wrap gap-2">
            {[
              ...
              {
                role: 'Admin',
                permissions: { view: true, edit: true, create: true, delete: true },
              },
                ...
                onClick={() => {
                  MODULES.forEach((module) => {
                    PERMISSION_LEVELS.forEach((level) => {
                      ...
                      onPermissionChange(
                        permKey,
                        permissions[level as keyof typeof permissions] || false
                      );
                    });
                  });
                }}
      ...
      {/* No User Selected */}
      {!selectedUser && (
        <div className="ivos-card py-12 text-center text-gray-500">
