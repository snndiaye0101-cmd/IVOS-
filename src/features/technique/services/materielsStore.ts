...
const SEED: Materiel[] = [
  {
    ...
    historique: [
      {
        date: '2025-11-10',
        description: 'Remplacement joint hydraulique',
        reparateur: 'Atelier Central',
  ...
  },
  {
    ...
    historique: [
      {
        date: '2026-01-15',
        description: 'Bobinage moteur',
        reparateur: 'ElecPro Dakar',
        tel: '+221 78 222 33 44',
        coutPieces: 35000,
        coutMo: 20000,
        total: 55000,
      },
      {
        date: '2026-03-20',
        description: 'Remplacement régulateur',
        reparateur: 'ElecPro Dakar',
        tel: '+221 78 222 33 44',
        coutPieces: 18000,
        coutMo: 8000,
  ...
  },
  {
    ...
    historique: [
      ...
      {
        date: '2025-09-15',
        description: 'Fuite cuve',
        reparateur: 'Soudure Express',
        tel: '+221 77 444 55 66',
        coutPieces: 15000,
        coutMo: 10000,
        total: 25000,
      },
  ...
  },
  {
    ...
    historique: [
      {
        date: '2026-02-28',
        description: 'Remplacement vérin',
        reparateur: 'HydroService',
        tel: '+221 70 555 66 77',
        coutPieces: 65000,
        coutMo: 25000,
        total: 90000,
      },
...
export const materielsStore = {
  ...
  save(data: Materiel[]) {
    try {
      ...
      try {
        window.dispatchEvent(new Event('materiels:updated'));
      } catch {}
    } catch {}
  },
