...
const fleetVehicles: MockVehicle[] = [
  { registration: 'DK-1000-AA', brand: 'Iveco', model: 'Daily' },
];
const personalVehicles: MockVehicle[] = [
  { registration: 'DK-2000-BB', brand: 'Toyota', model: 'Corolla' },
];
