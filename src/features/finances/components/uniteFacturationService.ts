...
const SEED: UniteFacturationItem[] = [
  ...
  {
    id: 3,
    type: 'Boues pétrolières',
    unit: 'Tonne',
    price: 35000,
    categorie: 'Opérations Spéciales',
...
export function addUniteFacturation(
  item: Omit<UniteFacturationItem, 'id' | 'updatedAt'>
): UniteFacturationItem {
