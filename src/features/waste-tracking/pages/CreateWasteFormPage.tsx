...
export default function CreateWasteFormPage() {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div className="mb-2 flex items-center justify-between rounded-2xl bg-gradient-to-r from-[#1a1a2e] via-[#16213e] to-[#0f3460] p-6 text-white">
        ...
        <button
          ...
          className="inline-flex items-center rounded-xl border border-white/20 bg-white/10 px-4 py-2 text-sm font-medium transition-colors hover:bg-white/20"
        >
      ...
      <div className="rounded-lg bg-white p-6 shadow">
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-lg border border-orange-200 bg-orange-50 p-4">
              ...
              <canvas
                ...
                className="w-full cursor-crosshair rounded border-2 border-orange-300 bg-white"
              />
        ...
        {currentSection === 'B' && (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
              <div>
                <label className="mb-2 block text-sm font-medium text-gray-700">Code déchet</label>
                <input
                  type="text"
              ...
              <div>
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    onChange={(e) =>
                      handleInputChange('estimated_quantity', parseFloat(e.target.value))
                    }
                    step="0.01"
                    min="0"
                  ...
                  <select
                    ...
                    className="w-32 rounded-md border border-gray-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-red-500"
                  >
        ...
        {currentSection === 'C' && (
          <div className="space-y-6">
            ...
            <div className="rounded-lg border border-blue-200 bg-blue-50 p-4">
              <h3 className="mb-2 text-sm font-medium text-blue-900">Signature du transporteur</h3>
              <canvas
                width={600}
                height={150}
                className="w-full cursor-crosshair rounded border-2 border-blue-300 bg-white"
              />
              <div className="mt-2 flex items-center justify-between">
        ...
        {currentSection === 'D' && (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
              ...
              <div>
                <label className="mb-2 block text-sm font-medium text-gray-700">N° NINEA</label>
                <input
                  type="text"
              ...
              <div>
                <label className="mb-2 block text-sm font-medium text-gray-700">Pesée réelle</label>
                <div className="flex gap-2">
                  <input
                    type="number"
                  ...
                  <select
                    ...
                    className="w-32 rounded-md border border-gray-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-500"
                  >
                    <option value="tonnes">Tonnes</option>
                    <option value="kg">kg</option>
                  </select>
              ...
              {(formData.acceptance_status === 'NON' ||
                formData.acceptance_status === 'PARTIEL') && (
                <div className="md:col-span-2">
                  <label className="mb-2 block text-sm font-medium text-gray-700">
            ...
            <div className="rounded-lg border border-green-200 bg-green-50 p-4">
              ...
              <canvas
                width={600}
                height={150}
                className="w-full cursor-crosshair rounded border-2 border-green-300 bg-white"
              />
              <div className="mt-2 flex items-center justify-between">
          ...
          <div className="flex gap-3">
            {currentSection !== 'D' ? (
              <button
                ...
                className="inline-flex items-center rounded-md border border-transparent bg-blue-600 px-6 py-2 text-sm font-medium text-white shadow-sm hover:bg-blue-700"
              >
                Suivant
              ...
              <button
                ...
                className="inline-flex items-center rounded-md border border-transparent bg-green-600 px-6 py-2 text-sm font-medium text-white shadow-sm hover:bg-green-700"
              >
