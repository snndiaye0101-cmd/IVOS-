...
Ce dossier regroupe les modules fonctionnels principaux du système IVOS (assurance, auth, chat, clients, direction, exploitation, finances, fleet, investments, operations, personnel, qhse, reporting, settings, etc.).

- Chaque sous-dossier correspond à une feature métier.
