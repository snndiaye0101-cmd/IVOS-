...
export async function generateCertificatePDF(certificate: Certificate): Promise<Blob> {
  ...
  const fields = [
    ...
    { label: 'Date de collecte', value: new Date(certificate.collectionDate).toLocaleDateString('fr-FR') },
    { label: 'Date de traitement', value: new Date(certificate.treatmentDate).toLocaleDateString('fr-FR') },
