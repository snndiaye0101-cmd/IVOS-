...
const SEED: Client[] = [
  {
    ...
    notes: 'Client historique depuis 2018',
    annee: '2026',
    archived: false,
  },
  {
    id: 2,
    name: 'Dangote Cement Senegal',
    type: 'Producteur',
    ninea: '005678912B3',
    address: 'Pout, Thiès',
    contact: 'Ibrahima Ndiaye',
    phone: '+221 33 951 20 00',
    email: 'info@dangote.sn',
    certifications: ['ISO 9001'],
    notes: 'Contrat annuel renouvelé',
    annee: '2026',
    archived: false,
  },
  {
    ...
    notes: 'Double rôle producteur/réceptionnaire',
    annee: '2026',
    archived: false,
  },
  {
    id: 4,
    name: 'Unilever Sénégal',
    type: 'Producteur',
    ninea: '003456789D4',
    address: 'Zone franche industrielle, Dakar',
    contact: 'Fatou Sow',
    phone: '+221 33 869 50 00',
    email: 'waste@unilever.sn',
  ...
  {
    id: 5,
    name: 'Centre de traitement PROMOGED',
    type: 'Réceptionnaire',
    ninea: '007890123E5',
    address: 'Sindia, Thiès',
    contact: 'Omar Sy',
    phone: '+221 77 654 32 10',
    email: 'reception@promoged.sn',
    certifications: ['Agrément DEEC'],
    notes: 'Centre agréé traitement déchets dangereux',
    annee: '2026',
    archived: false,
  },
  {
    ...
    type: 'Producteur',
    ninea: '004567890F6',
    address: 'Kirène, Thiès',
    contact: 'Cheikh Bamba',
    phone: '+221 33 836 70 00',
    email: 'environnement@cimaf.sn',
    certifications: [],
    notes: 'Nouveau client 2025',
    annee: '2025',
    archived: true,
  },
];
