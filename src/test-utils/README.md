...
Ce fichier regroupe les utilitaires de test partagés pour l’ensemble du projet IVOS.

- **test-utils.tsx** : Fonctions utilitaires pour les tests (render, mock, helpers).
