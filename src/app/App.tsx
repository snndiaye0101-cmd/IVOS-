...
const VehiculesPersonnelsPage = React.lazy(
  () => import('../features/fleet/pages/VehiculesPersonnelsPage')
);
...
const HandlingEquipmentPage = React.lazy(
  () => import('../features/fleet/pages/HandlingEquipmentPage')
);
...
const SpecialOperationsPage = React.lazy(
  () => import('../features/exploitation/pages/SpecialOperationsPage')
);
const ExploitationDashboardPage = React.lazy(
  () => import('../features/exploitation/pages/ExploitationDashboardPage')
);
...
const DemandeCongesMobile = React.lazy(
  () => import('../features/personnel/pages/DemandeCongesMobile')
);
const BornePointagePage = React.lazy(() => import('../features/personnel/pages/BornePointagePage'));
const DocumentsEntreprisePage = React.lazy(
  () => import('../features/personnel/pages/DocumentsEntreprisePage')
);
...
const MaintenanceStaffPage = React.lazy(
  () => import('../features/personnel/pages/MaintenanceStaffPage')
);
...
const UniteFacturation = React.lazy(
  () => import('../features/finances/components/UniteFacturation')
);
const LoanManagementPage = React.lazy(
  () => import('../features/finances/pages/LoanManagementPage')
);
const SalaryWithDeductionsPage = React.lazy(
  () => import('../features/finances/pages/SalaryWithDeductionsPage')
);
const FiscalRecapPage = React.lazy(() => import('../features/finances/pages/FiscalRecapPage'));
const GlobalExpensesPage = React.lazy(
  () => import('../features/finances/pages/GlobalExpensesPage')
);
...
const CertificateVerificationPage = React.lazy(
  () => import('../features/qhse/pages/CertificateVerificationPage')
);

// Technique (lazy)
const InventaireMaintenanceMateriels = React.lazy(
  () => import('../features/technique/pages/InventaireMaintenanceMateriels')
);
const InventaireMateriels = React.lazy(
  () => import('../features/technique/pages/InventaireMateriels')
);

// Settings (lazy)
const AdministrationSysteme = React.lazy(
  () => import('../features/settings/pages/AdministrationSysteme')
);
const UserManagementWithSuperAdmin = React.lazy(
  () => import('../features/auth/pages/UserManagementWithSuperAdmin')
);
const BaseConfigPage = React.lazy(() => import('../features/settings/pages/BaseConfigPage'));
const ClientsReferencePage = React.lazy(
  () => import('../features/settings/pages/ClientsReferencePage')
);
const AlertThresholdsPage = React.lazy(
  () => import('../features/settings/pages/AlertThresholdsPage')
);
...
const PayrollFiscalConfigPage = React.lazy(
  () => import('../features/settings/pages/PayrollFiscalConfigPage')
);
...
const EmailCenterAdminPage = React.lazy(
  () => import('../features/email-center/pages/EmailCenterAdminPage')
);
                  ...
                  <Suspense fallback={<PageLoader />}>
                    <Routes>
                      ...
                      >
                        ...
                        <Route
                          path="fleet/handling-equipment"
                          element={<HandlingEquipmentPage />}
                        />
                        ...
                        {/* Redirections */}
                        <Route
                          path="exploitation/tank-cleaning"
                          element={<Navigate to="/exploitation/special-operations" replace />}
                        />
                        {/* Technique */}
                        ...
                        <Route
                          ...
                          element={<InventaireMaintenanceMateriels />}
                        />
                        {/* Personnel & RH */}
                        ...
                        <Route
                          ...
                          element={<AdministrationSysteme />}
                        />
                        <Route
                          path="settings/base"
                          element={<Navigate to="/settings/system-config" replace />}
                        />
                        ...
                        <Route
                          ...
                          element={<PayrollFiscalConfigPage />}
                        />
                        {/* Finances */}
                        ...
                        <Route
                          path="finances/salary-deductions"
                          element={<SalaryWithDeductionsPage />}
                        />
                        ...
                        <Route
                          path="communications/email-center/admin"
                          element={<EmailCenterAdminPage />}
                        />
                        {/* QHSE & Reporting */}
