...
Ce dossier regroupe les modules, services, composants et utilitaires partagés entre plusieurs features du système IVOS.

- **services/** : Services transverses (voir README dédié).
- **components/** : Composants partagés (voir README dédié).
